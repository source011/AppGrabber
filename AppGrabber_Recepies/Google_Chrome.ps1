...
$urlVer = "https://filehippo.com/mac/download_google_chrome_for_mac/"
#$urlVer = "https://filehippo.com/download_google_chrome/"
...
$recepieVersion = $recepieVersion.innerText -replace ("Google Chrome for Mac ", "")
#$recepieVersion = $recepieVersion.innerText -replace ("Google Chrome ", "")
...
cls
echo [Installing SSO for Chrome]
regedit /S "%cd%\Chrome\chrome_sso.reg"
regedit /S "%cd%\Chrome\internet_zone.reg"
cls

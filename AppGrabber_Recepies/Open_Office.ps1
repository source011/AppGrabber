...
# Get version
$recepieVersion = ((Invoke-WebRequest -Uri 'http://www.openoffice.org/download/').Links | Where innerText -like "Apache OpenOffice*").innerText
$recepieVersion = $recepieVersion.Substring(18)
$recepieVersion = $recepieVersion -replace(" released", "")
